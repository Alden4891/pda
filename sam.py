...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'youtube search' in query:
            speak("What are you looking for in youtube?")
            keyword = myCommand()
            keyword = keyword.replace(' ','+')

            speak("Just a moment sir, Openning youtube for you!")
            time.sleep(1)
        ...
        elif 'goodbye '+ainame in query or  'nothing' in query:
